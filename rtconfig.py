...
LFLAGS = DEVICE + ' -O0 -ffunction-sections -fdata-sections -Wl,-Map,output.map -Wl,--gc-sections -T linkscripts/STM32H750XBHx/link.lds -nostartfiles --specs=nano.specs --specs=nosys.specs'
CPATH = ''
LPATH = ''
